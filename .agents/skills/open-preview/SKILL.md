...
Always use the project's restart script — it stops + starts both nest and vite with hidden windows per `AGENTS.md`:
...
These are project tools usable from any shell (Cursor / Codex / human). This skill is the Codex bundled version that also waits + opens the page.
