<template>
  <div class="page-card order-edit-page" v-loading="pageLoading">
    ...
    <el-card class="block-card">
      ...
      <el-row :gutter="16" class="a-area-row">
        <el-col :xs="24" :md="4" class="a-area-image-col">
          <div class="order-image-block" @dragover.prevent @drop.prevent="onOrderImageDrop">
    ...
    <OrderEditMaterialsCard
      :materials="materials"
      :set-materials-table-ref="setMaterialsTableRef"
      ...
      :material-name-options="materialNameOptions"
      :material-name-loading="materialNameLoading"
      :search-material-names="searchMaterialNames"
      :on-material-name-visible-change="onMaterialNameVisibleChange"
    />
    ...
    <OrderEditAttachmentsCard
      ...
      :attachments-file-dragover="attachmentsFileDragover"
      :on-attachment-file-change="onAttachmentFileChange"
      :on-attachments-area-drag-over="onAttachmentsAreaDragOver"
      :on-attachments-area-drag-leave="onAttachmentsAreaDragLeave"
      :on-attachments-area-drop="onAttachmentsAreaDrop"
