    ...
    return () => {
      ...
      const child = rootMenu.isMenuPopup ? h(
        ElTooltip,
        {
          ...
          transition: subMenuPopperClass.value && String(subMenuPopperClass.value).includes("sidebar-submenu-popper") ? "el-transition-none" : menuTransitionName.value,
          ...
          content: () => {
            ...
            return h(
              "div",
              {
                ...
                onMouseenter: (evt) => handleMouseenter(evt, 0),
                onMouseleave: () => handleMouseleave(true),
                onFocus: (evt) => handleMouseenter(evt, 0)
              },
              [
                h(
                  "ul",
      ...
      ) : (subMenuPopperClass.value && String(subMenuPopperClass.value).includes("sidebar-submenu-popper") ? h(Fragment, {}, [
        h(
          "div",
          {
            class: nsSubMenu.e("title"),
        ...
        withDirectives(
          h(
            ...
            [slots.default != null ? slots.default.call(slots) : void 0]
          ),
          [[vShow, opened.value]]
        )
      ]) : h(Fragment, {}, [
      ...
      const isSidebarSubmenu = subMenuPopperClass.value && String(subMenuPopperClass.value).includes("sidebar-submenu-popper");
      return h(
        "li",
        {
          class: [
            ...
            isSidebarSubmenu ? "submenu-no-transitions" : ""
          ],
          role: "menuitem",
          ariaHaspopup: true,
