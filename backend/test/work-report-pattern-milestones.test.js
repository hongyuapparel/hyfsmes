...
test('only first assignment from no sample maker counts as pattern completion',()=>{
 assert.deepEqual(patternHandoff('纸样分配：纸样师 吴小勇；车版师 王师傅'),{master:'吴小勇',maker:'王师傅'});
 assert.deepEqual(patternHandoff('修改纸样分配：纸样师 吴小勇→吴小勇；车版师 -→王师傅'),{master:'吴小勇',maker:'王师傅'});
 assert.equal(patternHandoff('修改纸样分配：纸样师 吴小勇→吴小勇；车版师 王师傅→张师傅'),null);
